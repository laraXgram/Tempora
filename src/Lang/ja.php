...
return [
    ...
    'calendar' => [
        'sameDay' => '[今日] LT',
        'nextDay' => '[明日] LT',
        'nextWeek' => static function (TemporaInterface $current, \Tempora\TemporaInterface $other) {
        ...
        'lastDay' => '[昨日] LT',
        'lastWeek' => static function (TemporaInterface $current, \Tempora\TemporaInterface $other) {
            if ($other->week !== $current->week) {
                return '[先週]dddd LT';
            }
