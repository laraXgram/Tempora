...
return [
    ...
    'calendar' => [
        ...
        'nextWeek' => static function (TemporaInterface $current, TemporaInterface $other) use ($daysOfWeekLocativum) {
        ...
        'lastWeek' => static function (TemporaInterface $current) use ($daysOfWeekLocativum) {
