...
$processHoursFunction = static function (TemporaInterface $date, string $format) {
...
return [
    ...
    'calendar' => [
        'sameDay' => static fn (TemporaInterface $date) => $processHoursFunction($date, '[Сьогодні '),
        'nextDay' => static fn (TemporaInterface $date) => $processHoursFunction($date, '[Завтра '),
        'nextWeek' => static fn (TemporaInterface $date) => $processHoursFunction($date, '[У] dddd ['),
        'lastDay' => static fn (TemporaInterface $date) => $processHoursFunction($date, '[Вчора '),
        'lastWeek' => static fn (TemporaInterface $date) => match ($date->dayOfWeek) {
    ...
    'weekdays' => static function (TemporaInterface $date, $format, $index) {
        static $words = [
