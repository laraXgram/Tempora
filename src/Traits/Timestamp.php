...
{
    /**
     * Create a Tempora instance from a timestamp and set the timezone (UTC by default).
     *
    ...
    /**
     * Create a Tempora instance from a timestamp keeping the timezone to UTC.
     *
     * Timestamp input can be given as int, float or a string containing one or more numbers.
     */
    ...
    /**
     * Create a Tempora instance from a timestamp in milliseconds.
     *
     * Timestamp input can be given as int, float or a string containing one or more numbers.
     *
