...
trait Serialization
{
     ...
     * @example
     * ```php
     * $object = Tempora::fromSerialized($value, ['allowed_classes' => [Tempora::class, TemporaImmutable::class]]);
     * ```
     *
     * @param \Stringable|string $value
     * @param array              $options example: ['allowed_classes' => [TemporaImmutable::class]]
     *
     ...
     *             You should rather transform Tempora object before the serialization.
     *
     * JSON serialize all Tempora instances using the given callback.
     */
