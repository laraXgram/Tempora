...
trait Modifiers
{
     ...
     * (second-precision).
     *
     * @param \LaraGram\Tempora\Tempora|\DateTimeInterface|null $date
     *
     * @return static
     */
    public function average($date = null)
    {
        return $this->addRealMicroseconds((int) ($this->diffInMicroseconds($this->resolveTempora($date), false) / 2));
    }

    /**
     * Get the closest date from the instance (second-precision).
     *
     * @param \LaraGram\Tempora\Tempora|\DateTimeInterface|mixed $date1
     * @param \LaraGram\Tempora\Tempora|\DateTimeInterface|mixed $date2
     *
     * @return static
     */
     ...
     *
     * @param \LaraGram\Tempora\Tempora|\DateTimeInterface|mixed $date
     *
     * @return static
     */
     ...
     * @example
     * ```
     * echo Tempora::now()->change('next 2pm');
     * ```
     *
