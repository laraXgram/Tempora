...
use DateTimeZone;
use Exception;
use LaraGram\Tempora\Exceptions\InvalidDateException;
use LaraGram\Tempora\Exceptions\InvalidFormatException;
use LaraGram\Tempora\Exceptions\InvalidTimeZoneException;
...
use LaraGram\Tempora\Translator;
use LaraGram\Tempora\TranslatorInterface;
 ...
 *
 * @method static Tempora|TemporaImmutable getTestNow()
 */
trait Creator
{
    ...
    /**
     * Create a Tempora instance from a DateTime one.
     */
    ...
    /**
     * Create a tempora instance from a string.
     *
     * This is an alias for the constructor that allows better fluent syntax
     * as it allows you to do Tempora::parse('Monday next week')->fn() rather
     * than (new Tempora('Monday next week'))->fn().
     *
     * @throws InvalidFormatException
     */
    ...
    /**
     * Create a tempora instance from a localized string (in French, Japanese, Arabic, etc.).
     *
    ...
    /**
     * Get a Tempora instance for the current date and time.
     */
    ...
    /**
     * Create a Tempora instance for today.
     */
    ...
    /**
     * Create a Tempora instance for tomorrow.
     */
    ...
    /**
     * Create a Tempora instance for yesterday.
     */
    ...
    /**
     * Create a new Tempora instance from a specific date and time.
     *
    ...
    /**
     * Create a new safe Tempora instance from a specific date and time.
     *
     * If any of $year, $month or $day are set to null their now() values will
     * be used.
     *
    ...
    /**
     * Create a new Tempora instance from a specific date and time using strict validation.
     *
     * @param int|null $year
     * @param int|null $month
     * @param int|null $day
    ...
    /**
     * Create a Tempora instance from just a date. The time portion is set to now.
     *
     * @param int|null $year
     * @param int|null $month
     * @param int|null $day
    ...
    /**
     * Create a Tempora instance from just a date. The time portion is set to midnight.
     *
     * @param int|null $year
     * @param int|null $month
     * @param int|null $day
    ...
    /**
     * Create a Tempora instance from just a time. The date portion is set to today.
     *
     * @param int|null $hour
     * @param int|null $minute
     * @param int|null $second
    ...
    /**
     * Create a Tempora instance from a time string. The date portion is set to today.
     *
     * @throws InvalidFormatException
     */
    ...
    /**
     * Create a Tempora instance from a specific format.
     *
    ...
    public static function rawCreateFromFormat(string $format, string $time, $timezone = null): ?self
    {
        ...
        /** @var \Tempora\TemporaImmutable|\Tempora\Tempora|null $mock */
    ...
    /**
     * Create a Tempora instance from a specific ISO format (same replacements as ->isoFormat()).
     *
     * @param string $format Datetime format
     * @param string $time
    ...
    public static function createFromIsoFormat(
        ...
        ?\LaraGram\Tempora\Translation\TranslatorInterface $translator = null
    ): ?self
    {
        ...
        $format = preg_replace_callback('/(?<!\\\\)(\\\\{2})*(' . TemporaInterface::ISO_FORMAT_REGEXP . '|[A-Za-z])/', function ($match) {
            [$code] = $match;
    ...
    /**
     * Create a Tempora instance from a specific format and a string in a given language.
     *
     * @param string $format Datetime format
     * @param string $locale
     * @param string $time
    ...
    /**
     * Create a Tempora instance from a specific ISO format and a string in a given language.
     *
    ...
    {
        $time = static::translateTimeString($time, $locale, static::DEFAULT_LOCALE, TemporaInterface::TRANSLATE_MONTHS | TemporaInterface::TRANSLATE_DAYS | TemporaInterface::TRANSLATE_MERIDIEM);

        return static::createFromIsoFormat($format, $time, $timezone, $locale);
    }

    /**
     * Make a Tempora instance from given variable if possible.
     *
