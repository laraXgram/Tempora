...
/**
 * A factory to generate Tempora instances with common settings.
 *
 ...
 *                                                                                                                                                                  new instance.
 * @method ?Tempora             create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $timezone = null)                                       Create a new Tempora instance from a specific date and time.
 ...
 *                                                                                                                                                                  will be 0.
 * @method Tempora              createFromDate($year = null, $month = null, $day = null, $timezone = null)                                                           Create a Tempora instance from just a date. The time portion is set to now.
 * @method ?Tempora             createFromFormat($format, $time, $timezone = null)                                                                                   Create a Tempora instance from a specific format.
 * @method ?Tempora             createFromIsoFormat(string $format, string $time, $timezone = null, ?string $locale = 'en', ?TranslatorInterface $translator = null) Create a Tempora instance from a specific ISO format (same replacements as ->isoFormat()).
 * @method ?Tempora             createFromLocaleFormat(string $format, string $locale, string $time, $timezone = null)                                               Create a Tempora instance from a specific format and a string in a given language.
 * @method ?Tempora             createFromLocaleIsoFormat(string $format, string $locale, string $time, $timezone = null)                                            Create a Tempora instance from a specific ISO format and a string in a given language.
 * @method Tempora              createFromTime($hour = 0, $minute = 0, $second = 0, $timezone = null)                                                                Create a Tempora instance from just a time. The date portion is set to today.
 * @method Tempora              createFromTimeString(string $time, DateTimeZone|string|int|null $timezone = null)                                                    Create a Tempora instance from a time string. The date portion is set to today.
 * @method Tempora              createFromTimestamp(string|int|float $timestamp, DateTimeZone|string|int|null $timezone = null)                                      Create a Tempora instance from a timestamp and set the timezone (UTC by default).
 *                                                                                                                                                                  Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Tempora              createFromTimestampMs(string|int|float $timestamp, DateTimeZone|string|int|null $timezone = null)                                    Create a Tempora instance from a timestamp in milliseconds.
 *                                                                                                                                                                  Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Tempora              createFromTimestampMsUTC($timestamp)                                                                                                 Create a Tempora instance from a timestamp in milliseconds.
 *                                                                                                                                                                  Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Tempora              createFromTimestampUTC(string|int|float $timestamp)                                                                                  Create a Tempora instance from a timestamp keeping the timezone to UTC.
 *                                                                                                                                                                  Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Tempora              createMidnightDate($year = null, $month = null, $day = null, $timezone = null)                                                       Create a Tempora instance from just a date. The time portion is set to midnight.
 * @method ?Tempora             createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $timezone = null)                 Create a new safe Tempora instance from a specific date and time.
 *                                                                                                                                                                  If any of $year, $month or $day are set to null their now() values will
 *                                                                                                                                                                  be used.
 *                                                                                                                                                                  If $hour is null it will be set to its now() value and the default
 *                                                                                                                                                                  values for $minute and $second will be their now() values.
 ...
 *                                                                                                                                                                  will be thrown.
 * @method Tempora              createStrict(?int $year = 0, ?int $month = 1, ?int $day = 1, ?int $hour = 0, ?int $minute = 0, ?int $second = 0, $timezone = null)   Create a new Tempora instance from a specific date and time using strict validation.
 ...
 * @method Tempora              fromSerialized($value)                                                                                                               Create an instance from a serialized string.
 ...
 * @method Tempora              instance(DateTimeInterface $date)                                                                                                    Create a Tempora instance from a DateTime one.
 ...
 * @method ?Tempora             make($var, DateTimeZone|string|null $timezone = null)                                                                                Make a Tempora instance from given variable if possible.
 *                                                                                                                                                                  Always return a new instance. Parse only strings and only these likely to be dates (skip intervals
 *                                                                                                                                                                  and recurrences). Throw an exception for invalid format, but otherwise return null.
 * @method void                mixin(object|string $mixin)                                                                                                          Mix another object into the class.
 * @method Tempora              now(DateTimeZone|string|int|null $timezone = null)                                                                                   Get a Tempora instance for the current date and time.
 * @method Tempora              parse(DateTimeInterface|WeekDay|Month|string|int|float|null $time, DateTimeZone|string|int|null $timezone = null)                    Create a tempora instance from a string.
 *                                                                                                                                                                  This is an alias for the constructor that allows better fluent syntax
 *                                                                                                                                                                  as it allows you to do Tempora::parse('Monday next week')->fn() rather
 *                                                                                                                                                                  than (new Tempora('Monday next week'))->fn().
 * @method Tempora              parseFromLocale(string $time, ?string $locale = null, DateTimeZone|string|int|null $timezone = null)                                 Create a tempora instance from a localized string (in French, Japanese, Arabic, etc.).
 * @method string              pluralUnit(string $unit)                                                                                                             Returns standardized plural of a given singular/plural unit name (in English).
 * @method ?Tempora             rawCreateFromFormat(string $format, string $time, $timezone = null)                                                                  Create a Tempora instance from a specific format.
 * @method Tempora              rawParse(DateTimeInterface|WeekDay|Month|string|int|float|null $time, DateTimeZone|string|int|null $timezone = null)                 Create a tempora instance from a string.
 *                                                                                                                                                                  This is an alias for the constructor that allows better fluent syntax
 *                                                                                                                                                                  as it allows you to do Tempora::parse('Monday next week')->fn() rather
 *                                                                                                                                                                  than (new Tempora('Monday next week'))->fn().
 ...
 * @method Tempora              today(DateTimeZone|string|int|null $timezone = null)                                                                                 Create a Tempora instance for today.
 * @method Tempora              tomorrow(DateTimeZone|string|int|null $timezone = null)                                                                              Create a Tempora instance for tomorrow.
 * @method string              translateTimeString(string $timeString, ?string $from = null, ?string $to = null, int $mode = TemporaInterface::TRANSLATE_ALL)        Translate a time string from a locale to an other.
 ...
 * @method Tempora              yesterday(DateTimeZone|string|int|null $timezone = null)                                                                             Create a Tempora instance for yesterday.
 *
 * </autodoc>
 */
class Factory
{
    protected string $className = Tempora::class;

    protected array $settings = [];

    /**
     * A test Tempora instance to be returned when now instances are created.
     */
    protected Closure|TemporaInterface|null $testNow = null;
    ...
    protected array $weekendDays = [
        TemporaInterface::SATURDAY,
        TemporaInterface::SUNDAY,
    ];
     ...
     */
    public function getTestNow(): Closure|TemporaInterface|null
    {
    ...
    public function handleTestNowClosure(
        Closure|TemporaInterface|null $testNow,
        ...
        if ($testNow instanceof Closure) {
            ...
            if ($testNow !== null && !($testNow instanceof DateTimeInterface)) {
                ...
                throw new RuntimeException(
                    ...
                    '; expected '.TemporaInterface::class.'|null',
                );
            }

            if (!($testNow instanceof TemporaInterface)) {
    ...
    public function __call(string $name, array $arguments): mixed
    {
        ...
        return $result instanceof TemporaInterface && !empty($settings)
     ...
     */
    protected function getMockedTestNow(DateTimeZone|string|int|null $timezone): ?TemporaInterface
    {
    ...
    private function setDefaultTimezone(string $timezone, ?DateTimeInterface $date = null): void
    {
        ...
        if (!$success) {
            $suggestion = @TemporaTimeZone::create($timezone)->toRegionName($date);
